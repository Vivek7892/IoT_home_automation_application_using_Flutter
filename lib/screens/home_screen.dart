...
class _HomeScreenState extends State<HomeScreen> {
                ...
                SingleChildScrollView(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        // ── My Channels section
                        _sectionHeader('My Channels', 'View All Channels',
                        ...
                        if (channels.isEmpty)
                          ...
                          SizedBox(
                            ...
                            child: ListView.separated(
                              ...
                              itemBuilder: (_, i) =>
                                  _channelChip(channels[i], i),
                            ),
                          ),
                        const SizedBox(height: 24),

                        // ── My Devices section
                        _sectionHeader('My Devices', 'View All Devices',
                        ...
                        if (allDevices.isEmpty)
                          ...
                          GridView.builder(
                            ...
                            itemCount:
                                allDevices.length > 4 ? 4 : allDevices.length,
                            itemBuilder: (_, i) =>
                                _deviceCard(allDevices[i], i),
                          ),
                        const SizedBox(height: 24),
    ...
    return Row(children: [
      ...
      if (btnLabel != null && onBtnTap != null)
        OutlinedButton.icon(
          ...
          label: Text(btnLabel,
              style:
                  const TextStyle(color: AppColors.textPurple, fontSize: 11)),
                ...
                PowerButton(
                    ...
                    onTap: () {
                      ...
                      if (ci != -1) {
                        final di = _store.channels.value[ci].devices.indexWhere(
                            (d) =>
                                d.name == device.name && d.plug == device.plug);
                        if (di != -1)
  ...
  Widget _sceneChip(SceneItem scene, int idx) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color:
                scene.isOn ? const Color(0xFFECEBFF) : const Color(0xFFF0F0F0),
  ...
  Widget _emptyState(
      String text, IconData icon, String btnLabel, VoidCallback onTap) {
